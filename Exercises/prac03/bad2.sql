...
insert into WorksFor values ('747-400-123','003',10);
-- should fail
insert into WorksFor values ('326-888-711','003',90);
insert into WorksFor values ('326-888-711','002',10);